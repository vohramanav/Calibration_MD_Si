...
%-----------Parameter screening tikz styles -----------------------
 ...
 \tikzstyle{pool} = [rectangle, minimum width=2.0cm, minimum height=4.0cm,line width=1pt,
...
10 Samples};
\node (gamma10) [gamma, right of=gamma5,xshift=2.5cm] {$\gamma$: 0.2531};
\node (alpha10) [alpha, right of=A5,xshift=2.5cm] {$\alpha$: 0.2170};
\node (A10) [A, right of=alpha5,xshift=2.5cm] {$A$: 0.2014};
\node (B10) [B, right of=q5,xshift=2.5cm] {$B$: 0.0964};
\node (p10) [p, right of=p5,xshift=2.5cm] {$p$: 0.0916};
\node (q10) [q, right of=lambda5,xshift=2.5cm] {$q$: 0.0741};
\node (lambda10) [lambda, right of=B5,xshift=2.5cm] {$\lambda$: 0.0664};
...
15 Samples};
\node (q15) [q, right of=gamma10,xshift=2.5cm] {$q$: 0.4999};
\node (gamma15) [gamma, right of=alpha10,xshift=2.5cm] {$\gamma$: 0.4968};
\node (alpha15) [alpha, right of=A10,xshift=2.5cm] {$\alpha$: 0.0031};
\node (A15) [A, right of=B10,xshift=2.5cm] {$A$: 0.0001};
\node (B15) [B, right of=p10,xshift=2.5cm] {$B$: 0.0001};
...
20 Samples};
\node (q20) [q, right of=q15,xshift=2.5cm] {$q$: 0.4999};
\node (gamma20) [gamma, right of=gamma15,xshift=2.5cm] {$\gamma$: 0.4967};
\node (alpha20) [alpha, right of=alpha15,xshift=2.5cm] {$\alpha$: 0.0031};
\node (A20) [A, right of=A15,xshift=2.5cm] {$A$: 0.0001};
\node (B20) [B, right of=B15,xshift=2.5cm] {$B$: 0.0001};
\node (p20) [p, right of=p15,xshift=2.5cm] {$p$: 0.0000};
\node (lambda20) [lambda, right of=lambda15,xshift=2.5cm] {$\lambda$: 0.0000};
\node (pool) [pool, below of=gamma20,yshift=-1.4cm]{};
