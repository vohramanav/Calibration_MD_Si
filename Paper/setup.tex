...
Essentially, a temperature gradient is applied by means of \rev{Langevin} thermostats located
...
\be
 \kappa = \frac{\rev{q''}}{\left|\frac{dT}{dz}\right|} 
\ee

\noindent where \rev{$q''$ denotes the steady state heat flux (W/m$^2$)} and
