...
\begin{tabular}{cc}
 ...
 (b) $T$ = 500~K. \rev{A straight line fit to the estimates is also illustrated in each case.}}
\label{fig:kinv}
\end{center}
\end{figure}
%
It is observed that the response surface estimates exhibit an expected linear trend, consistent with NEMD
  predictions. \rev{Using the y-intercept of the straight line fit, the bulk thermal conductivity was estimated
